...
import {
  require_classnames
} from "./chunk-6B5EA473.js";
import {
  require_react_dom
} from "./chunk-MMWG7BBY.js";
import {
  _inheritsLoose
} from "./chunk-3FH2SHEY.js";
import {
  _extends
} from "./chunk-2MYMMSKF.js";
import {
  _objectWithoutPropertiesLoose
} from "./chunk-EZ3RAZLO.js";
import "./chunk-J55EKTYP.js";
import {
  require_jsx_runtime
} from "./chunk-XNPXEWHZ.js";
import {
  require_prop_types
} from "./chunk-QPQEF2HK.js";
import "./chunk-VMGAOMNU.js";
import {
  require_react
...
function $b5e257d569688ac6$var$useLegacySSRSafeId(defaultId) {
  let ctx = (0, import_react43.useContext)($b5e257d569688ac6$var$SSRContext);
  if (ctx === $b5e257d569688ac6$var$defaultContext && !$b5e257d569688ac6$var$canUseDOM && process.env.NODE_ENV !== "production")
...
var DropdownMenu2 = React61.forwardRef(({
  ...
  if (align) {
    if (typeof align === "object") {
      ...
      process.env.NODE_ENV !== "production" ? (0, import_warning2.default)(keys.length === 1, "There should only be 1 breakpoint when passing an object to `align`") : void 0;
      if (keys.length) {
...
var FormControl = React74.forwardRef(({
  ...
  process.env.NODE_ENV !== "production" ? (0, import_warning3.default)(controlId == null || !id, "`controlId` is ignored on `<FormControl>` when `id` is specified.") : void 0;
...
var FormLabel = React77.forwardRef(({
  ...
  process.env.NODE_ENV !== "production" ? (0, import_warning4.default)(controlId == null || !htmlFor, "`controlId` is ignored on `<FormLabel>` when `htmlFor` is specified.") : void 0;
  htmlFor = htmlFor || controlId;
  if (column)
...
var ListGroupItem = React89.forwardRef(({
  ...
  process.env.NODE_ENV !== "production" ? (0, import_warning5.default)(as || !(!action && props.href), "`action=false` and `href` should not be used together.") : void 0;
...
var ListGroup = React90.forwardRef((props, ref) => {
  ...
  process.env.NODE_ENV !== "production" ? (0, import_warning6.default)(!(horizontal && variant === "flush"), '`variant="flush"` and `horizontal` should not be used together.') : void 0;
...
var Offcanvas = React113.forwardRef(({
  ...
  const {
    onToggle
  } = (0, import_react80.useContext)(NavbarContext_default) || {};
...
var OverlayTrigger = ({
  ...
  if (triggers.indexOf("hover") !== -1) {
    process.env.NODE_ENV !== "production" ? (0, import_warning7.default)(triggers.length > 1, '[react-bootstrap] Specifying only the `"hover"` trigger limits the visibility of the overlay to just mouse users. Consider also including the `"focus"` trigger so that touch and keyboard only users can see the overlay as well.') : void 0;
...
var ToggleButtonGroup = React150.forwardRef((props, ref) => {
  ...
  !(type !== "radio" || !!name) ? process.env.NODE_ENV !== "production" ? (0, import_invariant4.default)(false, 'A `name` is required to group the toggle buttons when the `type` is set to "radio"') : (0, import_invariant4.default)(false) : void 0;
